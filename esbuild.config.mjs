...
const vaultPath = "/Users/ruben/Library/Mobile Documents/iCloud~md~obsidian/Documents/git-notes-in-icloud/.obsidian/plugins/cambrer";
...
const copyPlugin = {
  ...
  setup: (build) => {
    build.onEnd(async (result) => {
	  ...
	  await fs.cp("monoid-italic.woff2", path.join(vaultPath, "monoid-italic.woff2"));
	  await fs.cp("monoid-regular.woff2", path.join(vaultPath, "monoid-regular.woff2"));
	  await fs.cp("monoid-bold.woff2", path.join(vaultPath, "monoid-bold.woff2"));
